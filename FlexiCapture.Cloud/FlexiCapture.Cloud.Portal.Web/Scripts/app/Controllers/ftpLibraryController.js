function actionFormatterFtpLibrary(value, row, index) {
    return [
        '<button class="btn btn-info orange-tooltip edit-ftp-library" href="javascript:void(0)" title="Preview" style=" text-align: center;" ',
...
function deleteFormatterFtpLibrary(value, row, index) {
    return [
        '<button class="btn btn-danger orange-tooltip delete-ftp-library" href="javascript:void(0)" title="Delete" style=" text-align: center;" ',
...
(function () {
    var ftpLibraryController = function ($scope,$interval, $http, $location, $state, $rootScope, $window, $cookies, usSpinnerService, Idle, Keepalive, $uibModal, documentsHttpService) {
        ...
        $window.actionEventsFtpLibrary = {
            'click .edit-ftp-library': function (e, value, row, index) {
            ...
            'click .delete-ftp-library': function (e, value, row, index) {
                BootstrapDialog.show({
                    title: 'Delete file',
