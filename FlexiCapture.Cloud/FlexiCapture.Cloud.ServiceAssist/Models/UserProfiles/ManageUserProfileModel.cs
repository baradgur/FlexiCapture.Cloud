    ...
    public class ManageUserProfileModel
    {
        ...
        public ManageUserProfileModel()
        {
            try
            {
                ...
                SelectedRotationType = CatalogHelper.ConvertToRotationTypeSingle(FlexiCapture.Cloud.ServiceAssist.DBHelpers.ManageUserProfileHelper.GetToDefaultRotationType());
                SelectedAnalysisModel= CatalogHelper.ConvertToAnalysisModelSingle(FlexiCapture.Cloud.ServiceAssist.DBHelpers.ManageUserProfileHelper.GetToDefaultAnalysisModel());
